...
def save_model(save_file: str, config: Dict, metadata: Dict, model: Optional['LLLMethodBase'] = None,
               buffer: Optional['BufferBase'] = None, datasets: Optional[Dict[str, TorchLLLDataset]] = None,
               **kwargs) -> None:
    """
    ...
    Args:
        ...
        model (Optional[LLLMethodBase]): The Method object (subclass of LLLMethodBase) for which the state dict should
            be saved (Default: None)
        buffer (Optional[BufferBase]): The buffer object for which the state dict should be saved (Default: None)
        datasets (Optional[Dict[str, TorchLLLDataset]]): The different dataset splits for which the state dict should be
            saved (Default: None)
...
def load_model(checkpoint: Dict[str, Dict], model: Optional['LLLMethodBase'] = None,
               buffer: Optional['BufferBase'] = None,
               datasets: Optional[Dict[str, TorchLLLDataset]] = None) -> None:
    """
