...
from lll_methods.utils import SubsetSampler, copy_freeze
from lll_methods.models import cosine_linear
...
class Model(LLLMethodBase):
    ...
    def _prepare_model_for_new_task(self, task_data: TorchLLLDataset, dist_args: Optional[dict] = None,
                                    **kwargs) -> None:
        """
    ...
    def _imprint_weights(self, task_data: TorchLLLDataset, model: Union[ResNet, ResNetCIFAR],
