...
from iirc.iirc_definitions import IIRC_SETUP, DatasetStructType


class TorchLLLDataset(LLLDatasetBase, data.Dataset):
    """
     A class inhereting from LLLDatasetBase to be used with PyTorch
    ...
    def __init__(self,
        ...
        super(TorchLLLDataset, self).__init__(dataset=dataset, tasks=tasks, setup=setup,
